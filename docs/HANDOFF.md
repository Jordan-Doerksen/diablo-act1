...
> Home repo: `diablo-act1` (C:\projects\games\diablo-act1).
...
## Stand up the repo
1. Repo: `diablo-act1`. <free & open? enable GitHub Pages → <user>.github.io/diablo-act1; MIT LICENSE.>
